            ...
            for idx,image in enumerate(imagePaths):
                ...
                if(expected):
                    if expected in [
                        ...
                        'HTML document filetype cannot be accepted',
                        'JSON text filetype cannot be accepted.',
                        f'The file {image_name} is too large. The maximum size you can upload is 256MB.',
                        'You are allowed to attach a maximum of 1 file(s) to this item'
                    ]:
                        try:
