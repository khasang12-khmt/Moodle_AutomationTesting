...
class TestMessage():
  ...
  #     self.precondtion()
  #     try:
  #       self.clickMessageDrawer()
  #       self.searchConver("Sam Student")
  ...
  #     try:
  #       self.clickMessageDrawer()
  #       self.clickConverDrawer(typ="private")
  #       self.logout()
  #       return True
  #     except Exception as err:
  #       self.logout()
  ...
  #     try:
  #       self.clickMessageDrawer()
  #       self.searchConver("abcdefasjdoaoljdfakisdkasndahsdjasdnakjsnd")
  #       time.sleep(2)
  ...
  def clickUserMenu(self):
      wait = WebDriverWait(self.driver, 10)
      um_btn = wait.until(EC.element_to_be_clickable((By.ID, "user-menu-toggle")))
      um_btn.click()

  def clickPrivateFile(self):
      wait = WebDriverWait(self.driver, 10)
      pf_btn = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "a[href='https://sandbox401.moodledemo.net/user/files.php']")))
      pf_btn.click()

  def addPrivateFile(self, value):
      wait = WebDriverWait(self.driver, 10)
      addbtn = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "a[title='Add...']")))
      addbtn.click()
      
      time.sleep(1)
      try:
          uploadway = self.driver.find_element(By.CSS_SELECTOR, "img[src^='https://sandbox401.moodledemo.net/theme/image.php/boost/repository_upload/']").find_element(By.XPATH, "..")
          uploadway.click()
      except: pass

      inputfile = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "input[name='repo_upload_file']")))
      inputfile.send_keys(value)

      uploadbtn = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "button[class='fp-upload-btn btn-primary btn']")))
      uploadbtn.click()
      cancelbtn = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "input[value='Cancel']")))
      def check_function(driver):
          try: 
              ...
              try:
                  overwrite = driver.find_element(By.CLASS_NAME, "fp-dlg-butoverwrite")
                  overwrite.click()
                  time.sleep(1)
                  cancelbtn.click()
                  return True
      ...
      WebDriverWait(self.driver, 50).until(check_function)
      end = time.perf_counter()
      time.sleep(1)
      return end - start

  def clickProfileUser(self):
      wait = WebDriverWait(self.driver, 10)
      profile_btn = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "a[href='https://sandbox401.moodledemo.net/user/profile.php']")))
      profile_btn.click()

  def clickMessageUser(self):
      wait = WebDriverWait(self.driver, 10)
      mess_user_btn = wait.until(EC.element_to_be_clickable((By.ID, "message-user-button")))
      mess_user_btn.click()
